...
public partial class ContextInfoGuia : DbContext
{
    public ContextInfoGuia(DbContextOptions<ContextInfoGuia> options)
        : base(options)
    {
    }

    public virtual DbSet<BranchOffice> BranchsOffices { get; set; }
    public virtual DbSet<BranchUser> BranchsUsers { get; set; }
